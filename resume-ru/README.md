...
#### 10.2012 - 01.2014
  ...
  ```text
  * игровой центр для мобильных устройств основаный на web-view (android, ios) (-webkit)
...
#### 04.2012 - 10.2012 OOO ALC
  ...
  * агрегатор служб доставки для интернет магазинов
  ...
  разработка архетикткуры, rest api, frontend + backend
...
#### 11.2011 - 04.2012 Global Advisors (DST)
  ...
  ```text
  * разработка и поддрежка внутрнней ERP системы
  ```
...
#### 07.2010 - 11.2012 OOO Grupper
  ...
  * бесплатные купоны
  ...
  виджит для сканирования qr-ковод в android
  ```
...
#### 02.2005 - 10.2007 РГУ Нефти и Газа
  ...
  ```text
  * оффициальный сайт РГУ Нефти и Газа
  миграция на сторонную CMS, поддержка кода
